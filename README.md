...
A live demo of the project is available at [https://bokepngewe.pages.dev](https://bokepngewe.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep ngewe`)
...
1. Fork the [repository](https://github.com/hariurdino/bokepngewe/fork) on GitHub.
