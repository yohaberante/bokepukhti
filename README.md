...
A live demo of the project is available at [https://bokepdedek.pages.dev](https://bokepdedek.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep dedek`)
...
1. Fork the [repository](https://github.com/vindaandio/bokepmama/fork) on GitHub.
