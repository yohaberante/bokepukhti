...
A live demo of the project is available at [https://bokeppelajar.pages.dev](https://bokeppelajar.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep pelajar`)
...
1. Fork the [repository](https://github.com/renisuwa/bokeppelajar/fork) on GitHub.
