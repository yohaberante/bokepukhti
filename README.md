...
A live demo of the project is available at [https://bokepsekolah.pages.dev](https://bokepsekolah.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep sekolah`)
...
1. Fork the [repository](https://github.com/etriasutopo/bokepsekolah/fork) on GitHub.
