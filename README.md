...
A live demo of the project is available at [https://bokepmodel.pages.dev](https://bokepmodel.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep model`)
...
1. Fork the [repository](https://github.com/taelsal/bokepmodel/fork) on GitHub.
