...
A live demo of the project is available at [https://bokepmama.pages.dev](https://bokepmama.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep mama`)
...
1. Fork the [repository](https://github.com/grasiwi/bokepkecil/fork) on GitHub.
